...
- [ ] **Two consecutive weeks of clean automated digests**
  ...
  - [x] Manual review time per PR < 10 minutes (week 1)
- [x] **One automated monthly due-list** — ran 2026-05-18; no issue opened (nothing due in Q2, correct)
- [x] **Document any v0.5/v0.6 issues in `retrospectives/2026-Q2.md`**
